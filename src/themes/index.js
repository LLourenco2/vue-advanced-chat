...
export const cssThemeVars = ({
    ...
    '--chat-font-size-input': general.fontSizeInput,
		...
		'--chat-message-font-size-timestamp': message.fontSizeTimestamp,
		...
		'--chat-message-font-size-system': message.fontSizeSystem,
